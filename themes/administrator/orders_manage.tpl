							...
							<div class="hor-scroll">
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" last"><a href="orders_manage.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&title={$title}&gtitle={$gtitle}&username={$username}&status={$status}{/if}&acancel=1&OID={$results[i].OID}">Cancel Order</a></td>
                                	</tr>
                                    {/section}
                                    <tr>
                                    	<td colspan="6">
