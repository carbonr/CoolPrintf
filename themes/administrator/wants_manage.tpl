        			...
        			<div id="customerGrid">
        				...
        				<tr>
            				...
            				<td class="filter-actions a-right">
                            	<button  id="id_ffba3971e132ae3d78c160244ea09b39" type="button" class="scalable " onclick="document.location.href='wants_manage.php'" style=""><span>Reset Filter</span></button>
                        ...
                        <div class="grid">
	    	    	    		...
	    	    	    		<tbody>
                                    ...
                                    <tr id="" >
                                        ...
                                        <td class=" ">
                                        	...
                                        	<a href="javascript: document.a{$results[i].WID}.submit();">{if $results[i].active eq "1"}Yes{else}No{/if}</a>
                                        </td>
                                        <td class=" last"><a href="wants_edit.php?WID={$results[i].WID}">Edit</a>&nbsp;|&nbsp;<a href="wants_manage.php?page={$currentpage}&sortby={$sortby}&sorthow={$sorthow}{if $search eq "1"}&fromid={$fromid}&toid={$toid}&want={$want}&username={$username}&status={$status}{/if}&delete=1&WID={$results[i].WID}">Delete</a></td>
                                	</tr>
                                    {/section}
                                    <tr>
                                    	<td colspan="5">
                            ...
                            <li >
                                <a href="wants_validate.php" id="isoft_group_2" name="group_2" title="Validate Wants" class="tab-item-link">
                                	<span>
                                    	<span class="changed" title=""></span>
                                        <span class="error" title=""></span>
                                        Validate Wants
					...
					<div class="main-col" id="content">
						<div class="main-col-inner">
                            ...
                            <div class="content-header">
                               <h3 class="icon-head head-products">Wants - Manage Wants</h3>
                            </div>
                            
                            <form action="wants_manage.php" method="post" id="main_form" name="main_form" enctype="multipart/form-data">
